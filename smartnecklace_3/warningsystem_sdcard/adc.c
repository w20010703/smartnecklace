...
void adc_init(void)
{
	...
	/* ADC Common Init **********************************************************/
	ADC_CommonInitStructure.ADC_Mode 		     = ADC_TripleMode_RegSimult; //ADC_TripleMode_RegSimult;
...
void adc_dma_init(void)
{
  ...
  DMA_DeInit(DMA2_Stream2);  //Set DMA registers to default values
  DMA_InitStructure.DMA_Channel            = DMA_Channel_1;
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&ADC2->DR; //Source address
  DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)&ADC2Value[0]; //Destination address
  DMA_InitStructure.DMA_DIR                = DMA_DIR_PeripheralToMemory;
  DMA_InitStructure.DMA_BufferSize         = CAPTURE_BUFFER_SIZE; //Buffer size
  DMA_InitStructure.DMA_PeripheralInc      = DMA_PeripheralInc_Disable;
  DMA_InitStructure.DMA_MemoryInc          = DMA_MemoryInc_Enable;
  ...
  DMA_DeInit(DMA2_Stream1);  //Set DMA registers to default values
  DMA_InitStructure.DMA_Channel            = DMA_Channel_2;
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&ADC3->DR; //Source address
  DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)&ADC3Value[0]; //Destination address
  DMA_InitStructure.DMA_DIR                = DMA_DIR_PeripheralToMemory;
  DMA_InitStructure.DMA_BufferSize         = CAPTURE_BUFFER_SIZE; //Buffer size
  DMA_InitStructure.DMA_PeripheralInc      = DMA_PeripheralInc_Disable;
  DMA_InitStructure.DMA_MemoryInc          = DMA_MemoryInc_Enable;
...
void DONT_DISCARD DMA2_Stream2_IRQHandler(void)
{
...
void DONT_DISCARD DMA2_Stream1_IRQHandler(void)
{
