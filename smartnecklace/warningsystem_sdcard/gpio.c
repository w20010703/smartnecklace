...
void gpio_init() 
{
	...
	TM_GPIO_Init(GPIOC, GPIO_Pin_2 | GPIO_Pin_1, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High);
	TM_GPIO_Init(GPIOB, GPIO_Pin_6 | GPIO_Pin_7, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High);
	//TM_GPIO_Init(GPIOC, GPIO_Pin_2 | GPIO_Pin_7, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, GPIO_Speed_100MHz);
	TM_GPIO_SetPinValue(GPIOB, GPIO_Pin_6, 1);
	TM_GPIO_SetPinValue(GPIOB, GPIO_Pin_7, 1);
}
...
{
	uint8_t dat;
	dat = TM_GPIO_GetInputPinValue(GPIOA, GPIO_Pin_0);
	return(dat);
}
